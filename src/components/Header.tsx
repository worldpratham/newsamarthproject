...
const aboutDropdownLinks = [
  { label: 'Bhaorao Deoras Seva Nyas', path: '/about' },
  { label: 'Samarth Bharat Introduction', path: '/about' },
  { label: 'Project Team', path: '/about' },
];

const successDropdownLinks = [
  { label: 'Success Stories', path: '/success-stories' },
  { label: 'Gallery', path: '/events' },
];
...
const navLinks = [
  ...
  { label: 'Career Development Center', path: '/courses' },
  { label: 'Community Training Programs', path: '/courses' },
  { label: 'Centres Details', path: '/about' },
  { label: 'Events & Activities', path: '/events' },
  { label: 'Bharat In Consult', path: 'https://consult.samarthbharat.net/', isExternal: true },
];
              ...
              {navLinks.map((link) => (
                ...
                >
                  {link.isExternal ? (
                    ...
                    >
                      {link.label}
                      {link.dropdown && <ChevronDown size={13} className="mt-0.5 opacity-70" />}
                    </Link>
                  )}
