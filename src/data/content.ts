...
export const courseAnnouncements: CourseAnnouncement[] = [
  { title: 'Beautician and Nail Art Course', link: '/courses' },
  { title: 'RACW Course', link: '/courses' },
  { title: 'Bakery Course', link: '/courses' },
  { title: 'GDA (General Duty Assistant Course)', link: '/courses' },
  { title: 'Cutting & Tailoring Course', link: '/courses' },
  { title: 'Truck Repairing Course', link: '/courses' },
];
